...
CONTAINS
  ...
  SUBROUTINE Darcy_EquationsSetSolutionMethodSet(EQUATIONS_SET,SOLUTION_METHOD,err,error,*)
    ...
    IF(ASSOCIATED(EQUATIONS_SET)) THEN
      ...
      CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
        & EQUATIONS_SET_QUASISTATIC_DARCY_SUBTYPE, EQUATIONS_SET_ALE_DARCY_SUBTYPE, &
         ...
         CASE(EQUATIONS_SET_SETUP_INITIAL_TYPE)
          SELECT CASE(EQUATIONS_SET%SPECIFICATION(3))
           CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
            ...
            write(*,*)'It comes to s o l u t i o n   m e t h o d standard darcy'
           ...
           CASE(EQUATIONS_SET_MULTI_COMPARTMENT_DARCY_SUBTYPE,EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE)
            write(*,*)'It comes to s o l u t i o n   m e t h o d multi-comp darcy'
            SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
...
!!TODO: Check valid setup
        ...
        CASE(EQUATIONS_SET_SETUP_GEOMETRY_TYPE)
          ...
          CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
            ...
            write(*,*)'It comes to g e o m e t r y   f i e l d standard darcy'
          !Do nothing
        ...
        CASE(EQUATIONS_SET_SETUP_DEPENDENT_TYPE)
          ...
          CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
            ...
            & EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE, &
            & EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE)
            write(*,*)'It comes to d e p e n d e n t   f i e l d standard darcy'
            SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
            CASE(EQUATIONS_SET_SETUP_START_ACTION)
              IF(EQUATIONS_SET%DEPENDENT%DEPENDENT_FIELD_AUTO_CREATED) THEN
                !Create the auto created dependent field
                write(*,*)'It creates auto create dependent field'
                CALL FIELD_CREATE_START(EQUATIONS_SET_SETUP%FIELD_USER_NUMBER,EQUATIONS_SET%REGION, &
              ...
              ELSE
                ...
                CASE(EQUATIONS_SET_INCOMPRESSIBLE_FINITE_ELASTICITY_DARCY_SUBTYPE, &
                  ...
                  CASE(EQUATIONS_SET_INCOMPRESSIBLE_FINITE_ELASTICITY_DARCY_SUBTYPE)
                    write(*,*)'It comes to INCOMPRESSIBLE_FINITE_ELASTICITY_DARCY'
                  ...
                  CASE(EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE)
                    write(*,*)'It comes to INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY'
        ...
        CASE(EQUATIONS_SET_SETUP_INDEPENDENT_TYPE)
          ...
          CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
            ...
            & EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE, &
            & EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE)
            write(*,*)'It comes to I N d e p e n d e n t   f i e l d standard darcy'
            !\todo: revise: do they all need an independent field ?
            SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
            CASE(EQUATIONS_SET_SETUP_START_ACTION)
              IF(EQUATIONS_SET%INDEPENDENT%INDEPENDENT_FIELD_AUTO_CREATED) THEN
                !Create the auto created INdependent field
                write(*,*)'It creates auto create Independent field'
                CALL FIELD_CREATE_START(EQUATIONS_SET_SETUP%FIELD_USER_NUMBER,EQUATIONS_SET%REGION, &
        ...
        CASE(EQUATIONS_SET_SETUP_MATERIALS_TYPE)
          ...
          CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
            ...
            write(*,*)'It comes to m a t e r i a l   f i e l d standard darcy'
            SELECT CASE(EQUATIONS_SET%SPECIFICATION(3))
            CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE,EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
                 & EQUATIONS_SET_QUASISTATIC_DARCY_SUBTYPE,EQUATIONS_SET_ALE_DARCY_SUBTYPE)
              !Porosity + scalar permeability/viscosity+beta(for Brinkman)set to zero for darcy....
              MATERIAL_FIELD_NUMBER_OF_COMPONENTS = 3
            CASE DEFAULT
            ...
            CASE(EQUATIONS_SET_SETUP_START_ACTION)
              ...
              IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
                IF(EQUATIONS_MATERIALS%MATERIALS_FIELD_AUTO_CREATED) THEN
                  write(*,*)'It creates auto create material field'
        ...
        CASE(EQUATIONS_SET_SETUP_ANALYTIC_TYPE)
          ...
          SELECT CASE(EQUATIONS_SET%SPECIFICATION(3))
          CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE,EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE)
              write(*,*)'It comes to a n a l y t i c   f i e l d standard darcy'
              SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
                !Set start action
                CASE(EQUATIONS_SET_SETUP_START_ACTION)
                      ...
                      IF(ASSOCIATED(EQUATIONS_SET%GEOMETRY%GEOMETRIC_FIELD)) THEN
                        ...
                        SELECT CASE(EQUATIONS_SET_SETUP%ANALYTIC_FUNCTION_TYPE)
                          ...
                          CASE(EQUATIONS_SET_INCOMP_ELAST_DARCY_ANALYTIC_DARCY)
                            write(*,*)'Three Dimension-Incompress'
                            !Set analytic function type
        ...
        CASE(EQUATIONS_SET_SETUP_SOURCE_TYPE)
          ...
          CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
            ...
            & EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE, &
            & EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE)
            write(*,*)'It comes to  s o u r c e   t y p e   -   include gravity at some point standard darcy'
            SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
            CASE(EQUATIONS_SET_SETUP_START_ACTION)
        ...
        CASE(EQUATIONS_SET_SETUP_EQUATIONS_TYPE)
          ...
          CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE,EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
            ...
            write(*,*)'It comes to  e q u a t i o n s   t y p e   -   s t a t i c'
            SELECT CASE(EQUATIONS_SET_SETUP%ACTION_TYPE)
            CASE(EQUATIONS_SET_SETUP_START_ACTION)
              EQUATIONS_MATERIALS=>EQUATIONS_SET%MATERIALS
              IF(ASSOCIATED(EQUATIONS_MATERIALS)) THEN
...
999 ERRORSEXITS("DARCY_EQUATION_EQUATIONS_SET_SETUP",err,error)
  ...
  SUBROUTINE DARCY_EQUATION_FINITE_ELEMENT_CALCULATE(EQUATIONS_SET,ELEMENT_NUMBER,err,error,*)
    ...
    INTEGER(INTG) :: idxdim1,ng1,ng2,mii,nii,sum_1,sum_v,sum_w,sum_p,sum_pw
    ...
    INTEGER(INTG), POINTER :: equations_SET_FIELD_DATA(:)
    REAL(DP) :: RWG,SUM,PGMSI(3),PGNSI(3),PGM,PGN,COUPLING_PARAM,PGNSII(3),PGMSII(3),PGNSIII(3),PGMSIII(3)
...
!!TODO: move these and scale factor adjustment out once generalised Darcy is put in.
          ...
          CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, &
            & EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, EQUATIONS_SET_QUASISTATIC_DARCY_SUBTYPE, &
...
!             END DO
          ...
          CASE(EQUATIONS_SET_TRANSIENT_DARCY_SUBTYPE,EQUATIONS_SET_TRANSIENT_ALE_DARCY_SUBTYPE, &
            & EQUATIONS_SET_ELASTICITY_DARCY_INRIA_MODEL_SUBTYPE, &
            & EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE)
              write(*,*)'It comes here - Impermeable penalty boundary condition'
...
!             !*** If material is variable, need to account for this in deriving the variational statement ***!
            ...
            CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE,EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
              ...
              PERM_TENSOR_OVER_VIS=PERM_TENSOR_OVER_VIS*(1.0_DP/MATERIALS_INTERPOLATED_POINT%VALUES(1,NO_PART_DERIV))
			  BETA=MATERIALS_INTERPOLATED_POINT%VALUES(3,NO_PART_DERIV)
...
!             RWG = equations%interpolation%geometricInterpPointMetrics%JACOBIAN * QUADRATURE_SCHEME%GAUSS_WEIGHTS(ng)
            ...
            DO mh=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
              !write(*,*)'This is over element rows'
                  ...
                  DO nh=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
                    ...
                    DO ns=1,DEPENDENT_BASIS_2%NUMBER_OF_ELEMENT_PARAMETERS
                      ...
                      CASE(EQUATIONS_SET_INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE)
                        ...
                        write(*,*)'Inside the INCOMPRESSIBLE_ELASTICITY_DRIVEN_DARCY_SUBTYPE'
...
!                           END IF
                      ...
                      CASE(EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE)
                        write(*,*)'It comes to EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE'
                        !velocity test function, velocity trial function
                        IF(mh==nh.AND.nh<FIELD_VARIABLE%NUMBER_OF_COMPONENTS) THEN
...
!                           END IF
                      ...
                      CASE(EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE)
                        ! This is the Darcy Brinkman subtype which is incorporated into the system.
                        ...
                        IF(mh==nh.AND.nh<NUMBER_OF_VEL_PRESS_COMPONENTS) THEN
                          ...
                          !Evaluate the double derivatives here....
						  
			              DO J1=1,DEPENDENT_BASIS_1%NUMBER_OF_XI
                            PGMSII(J1)=QUADRATURE_SCHEME_1%GAUSS_BASIS_FNS(ms,PARTIAL_DERIVATIVE_SECOND_DERIVATIVE_MAP(J1),ng)
                          ENDDO

                          DO J2=1,DEPENDENT_BASIS_2%NUMBER_OF_XI
                            PGNSII(J2)=QUADRATURE_SCHEME_2%GAUSS_BASIS_FNS(ns,PARTIAL_DERIVATIVE_SECOND_DERIVATIVE_MAP(J2),ng)
                          ENDDO !ni
						  
                          DO idxdim =1,DEPENDENT_BASIS_1%NUMBER_OF_XI !number space dimension equiv. number of xi
                            DO mi=1,DEPENDENT_BASIS_1%NUMBER_OF_XI
                              DO ni=1,DEPENDENT_BASIS_2%NUMBER_OF_XI
                                  SUM = SUM + BETA * PGMSI(mi) * PGNSI(ni) * &
                          ...
                          ENDDO !idxdim
                          l1 = beta
                          l2 = VIS_OVER_PERM_TENSOR( mh, nh )
                          GRAD_DIV_FACTOR = max(l1,l2,1.0)

                          IF(STABILIZED)THEN !add the stabilisation terms here....
						    !Terms corresponding to Brinkman Stabilisation------------------------------------------------------------------------
                            !Evaluate the laplacian of the first shape function...
                            DO idxdim=1,DEPENDENT_BASIS_1%NUMBER_OF_XI
                              DO mi=1,DEPENDENT_BASIS_1%NUMBER_OF_XI
                                  SUM_D = SUM_D+PGMSII(mi)*((equations%interpolation% &
                                  & geometricInterpPointMetrics(FIELD_U_VARIABLE_TYPE)%ptr%DXI_DX(mi,idxdim))**2)
                              ENDDO !mi
                            ENDDO !idxdim
                            !Evaluate the laplacian of the second shape function...
			                DO idxdim=1,DEPENDENT_BASIS_2%NUMBER_OF_XI
                              DO ni=1,DEPENDENT_BASIS_2%NUMBER_OF_XI
                                  SUM_D1 = SUM_D1+PGNSII(ni)*((equations%interpolation% &
                                  & geometricInterpPointMetrics(FIELD_U_VARIABLE_TYPE)%ptr%DXI_DX(ni,idxdim))**2)
                              ENDDO !ni
                            ENDDO !idxdim

                            !First term for Brinkman stabilisation...(velocity side)
			                !SUM = SUM - ((0.5_DP) * l1 * l1 * SUM_D * SUM_D1)
                            !Second term for the Brinkman Stabilisation...(velocity side)
			                !SUM = SUM + ((0.5_DP) * l1 * VIS_OVER_PERM_TENSOR(mh,nh) * SUM_D * PGN)
			                !Third term for Brinkman Stabilisation... (velocity Side)
                            !SUM = SUM + ((0.5_DP) * l1 * VIS_OVER_PERM_TENSOR(mh,nh) * SUM_D1 * PGM)
			                ! ---------------------------------------------------------------------------------------------------------
			                ! This part of the terms corresponds to the grad div stabilisation used -------------------------
                            DO mi=1,DEPENDENT_BASIS_1%NUMBER_OF_XI
                              DO ni=1,DEPENDENT_BASIS_2%NUMBER_OF_XI
                                  SUM = SUM + (1)*(PGMSI(mi) * &
                                  & equations%interpolation%geometricInterpPointMetrics(FIELD_U_VARIABLE_TYPE)%ptr% &
                                  & DXI_DX(mi,mh)) *(PGNSI(ni)* equations%interpolation% &
                                  & geometricInterpPointMetrics(FIELD_U_VARIABLE_TYPE)%ptr%DXI_DX(ni,nh))
                              ENDDO !ni
                            ENDDO !mi
							!---------------------------------------------------------------------------------------------
							! This following term is related to the Darcy stabilisation----------------------------------------------
                            SUM = SUM - 0.5000_DP * VIS_OVER_PERM_TENSOR( mh, nh ) * PGM * PGN
							!--------------------------------------------------------------------------------------------------------
                          END IF
                        ...
                        ELSE IF(mh<NUMBER_OF_VEL_PRESS_COMPONENTS.AND.nh==NUMBER_OF_VEL_PRESS_COMPONENTS) THEN
                          ...
                          IF( STABILIZED ) THEN
							...
							DO idxdim=1,DEPENDENT_BASIS_2%NUMBER_OF_XI
                              ...
                              ENDDO !ni
                            ENDDO !idxdim
							!First term for Brinkman Stabilisation....(Pressure Side)
							!SUM = SUM + (0.5_DP * BETA * PGN * SUM_D)
							!-------------------------------------------------------------------------------------------------------------
							!Terms added for Darcy Stabilisation-----------------------------------------------------------------------------
                            DO ni=1,DEPENDENT_BASIS_2%NUMBER_OF_XI
                              SUM = SUM - 0.5000_DP * PGM * PGNSI(ni) * &
                        ...
                        ELSE IF(mh==NUMBER_OF_VEL_PRESS_COMPONENTS.AND.nh<NUMBER_OF_VEL_PRESS_COMPONENTS) THEN
			              ...
			              IF( STABILIZED ) THEN
                            ...
                            ENDDO !idxdim
							!First term for Brinkman Stabilisation....(Pressure Side)
							!SUM = SUM + (0.5_DP * BETA * PGM * SUM_D1)
							!------------------------------------------------------------------------------------------------------
							! Terms added for Darcy Stabilisation--------------------------------------------------------------
                            DO mi=1,DEPENDENT_BASIS_1%NUMBER_OF_XI
                              SUM = SUM + 0.500_DP * PGMSI(mi) * PGN * &
                        ...
                        ELSE IF(mh==nh.AND.nh==NUMBER_OF_VEL_PRESS_COMPONENTS) THEN
                          ...
                          IF(STABILIZED)THEN
                            DO idxdim =1,DEPENDENT_BASIS_1%NUMBER_OF_XI !number space dimension equiv. number of xi
                              DO mi=1,DEPENDENT_BASIS_1%NUMBER_OF_XI
                                DO ni=1,DEPENDENT_BASIS_2%NUMBER_OF_XI
                                  SUM = SUM + 0.5000_DP * PERM_TENSOR_OVER_VIS( idxdim, idxdim ) * PGMSI(mi) * PGNSI(ni) * &
                                    & equations%interpolation%geometricInterpPointMetrics(FIELD_U_VARIABLE_TYPE)%ptr% &
                                    & DXI_DX(mi,idxdim) * equations%interpolation% &
                                    & geometricInterpPointMetrics(FIELD_U_VARIABLE_TYPE)%ptr%DXI_DX(ni,idxdim)
                                ENDDO !ni
                      ...
                      CASE DEFAULT
                        !-------------------------------------------------------------------------------------------------------------
                        !velocity test function, velocity trial function
                        !write(*,*)'It comes to d e f a u l t   :   M A T R I C E S'
                        IF(mh==nh.AND.nh<NUMBER_OF_VEL_PRESS_COMPONENTS) THEN
                          ...
                          IF( STABILIZED ) THEN
                            SUM = SUM - 0.500_DP * VIS_OVER_PERM_TENSOR( mh, nh ) * PGM * PGN
                          END IF
...
!                           & equations%interpolation%geometricInterpPointMetrics(FIELD_U_VARIABLE_TYPE)%ptr%DXI_DX(mi,mh)
                    ...
                    END IF
                  !=================================================================================
                  !    d a r c y    b r i n k m a n    s u b t y p e
                  CASE(EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE)
                    !-----------------------------------------------------------------------------------------------------------------
                    !velocity test function
                ...
                DO mh=1,FIELD_VARIABLE%NUMBER_OF_COMPONENTS
                  ...
                  DO ms=1,DEPENDENT_BASIS_1%NUMBER_OF_ELEMENT_PARAMETERS
                    ...
                    ELSE IF(EQUATIONS_SET%ANALYTIC%ANALYTIC_FUNCTION_TYPE==EQUATIONS_SET_DARCY_EQUATION_THREE_DIM_2) THEN
                      IF(mh==NUMBER_OF_VEL_PRESS_COMPONENTS) THEN
					    !write(*,*)'It comes here to calculate the analytic function as source'
                        FACT   = PERM_OVER_VIS_PARAM
                        ARG(1) = X(1)
                        ARG(2) = X(2)
                        ARG(3) = X(3)
                        SOURCE = 3.0_DP*(exp(arg(1)+arg(2)+arg(3)))
                        SUM = PGM * SOURCE
                      ELSE
                        SUM = 0.0_DP
                      ENDIF
...
999 ERRORSEXITS("DARCY_EQUATION_FINITE_ELEMENT_CALCULATE",err,error)
  ...
  SUBROUTINE Darcy_FiniteElementFaceIntegrate(equationsSet,elementNumber,dependentVariable,err,error,*)
	...
	REAL(DP), DIMENSION(3,3) :: gradient_velocity
    REAL(DP), DIMENSION(3) :: vector_gradient
    REAL(DP), DIMENSION(3) :: normal_vector
    LOGICAL :: BRINKMAN
    ...
    SELECT CASE(equationsSet%specification(3))
    CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, &
        & EQUATIONS_SET_DARCY_BRINKMAN_SUBTYPE, &
        & EQUATIONS_SET_QUASISTATIC_DARCY_SUBTYPE, &
        & EQUATIONS_SET_ALE_DARCY_SUBTYPE, &
        & EQUATIONS_SET_TRANSIENT_DARCY_SUBTYPE)
  ...
  SUBROUTINE Darcy_EquationsSetSpecificationSet(equationsSet,specification,err,error,*)
    ...
    IF(ASSOCIATED(equationsSet)) THEN
      ...
      CASE(EQUATIONS_SET_STANDARD_DARCY_SUBTYPE, &
          ...
          & EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE)
        !ok
        write(*,*)'It enters equation specification for a Darcy equation type of a fluid mechanics equations set class'
      CASE DEFAULT
...
999 ERRORS("Darcy_EquationsSetSpecificationSet",err,error)
  ...
  SUBROUTINE Darcy_ProblemSpecificationSet(problem,problemSpecification,err,error,*)
    ...
    write(*,*)'It enters Darcy_ProblemSpecificationSet'
    IF(ASSOCIATED(problem)) THEN
      IF(SIZE(problemSpecification,1)==3) THEN
        problemSubtype=problemSpecification(3)
        SELECT CASE(problemSubtype)
        CASE(PROBLEM_STANDARD_DARCY_SUBTYPE, &
            & PROBLEM_DARCY_BRINKMAN_SUBTYPE, &
...
!     ENTERS("DARCY_EQUATION_PROBLEM_STANDARD_SETUP",err,error,*999)
    ...
    write(*,*)'It enters DARCY_EQUATION_PROBLEM_SETUP'
    ...
    IF(ASSOCIATED(PROBLEM)) THEN
      ...
      !-----------------------------------------------------------------
      CASE(PROBLEM_STANDARD_DARCY_SUBTYPE,PROBLEM_DARCY_BRINKMAN_SUBTYPE)
        write(*,*)'It enters DARCY_EQUATION_PROBLEM_STANDARD_SETUP'
        ...
        CASE(PROBLEM_SETUP_CONTROL_TYPE)
          write(*,*)'It enters PROBLEM_SETUP_CONTROL_TYPE'
          SELECT CASE(PROBLEM_SETUP%ACTION_TYPE)
          CASE(PROBLEM_SETUP_START_ACTION)
        ...
        CASE(PROBLEM_SETUP_SOLVERS_TYPE)
          write(PROBLEM_SETUP_SOLVERS_TYPE)
          write(*,*)'It enters DARCY_EQUATION_PROBLEM_SETUP_PROBLEM_SETUP_SOLVERS_TYPE'
        ...
        CASE(PROBLEM_SETUP_SOLVER_EQUATIONS_TYPE)
          write(*,*)'It enters DARCY_EQUATION_PROBLEM_SETUP_PROBLEM_SETUP_SOLVER_EQUATIONS_TYPE'
          SELECT CASE(PROBLEM_SETUP%ACTION_TYPE)
          CASE(PROBLEM_SETUP_START_ACTION)
            !Get the control loop
            CONTROL_LOOP_ROOT=>PROBLEM%CONTROL_LOOP
      ...
      CASE(PROBLEM_ALE_DARCY_SUBTYPE,PROBLEM_PGM_DARCY_SUBTYPE)
        write(*,*)'Going into wrong routine'
        SELECT CASE(PROBLEM_SETUP%SETUP_TYPE)
        CASE(PROBLEM_SETUP_INITIAL_TYPE)
          SELECT CASE(PROBLEM_SETUP%ACTION_TYPE)
          CASE(PROBLEM_SETUP_START_ACTION)
...
!   END SUBROUTINE DARCY_EQUATION_PROBLEM_STANDARD_SETUP
  ...
  SUBROUTINE DARCY_EQUATION_PRE_SOLVE(CONTROL_LOOP,SOLVER,err,error,*)
    ...
    write(*,*)'It enters DARCY_EQUATION_PRE_SOLVE'
      ...
      IF(ASSOCIATED(SOLVER)) THEN
        IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
          ...
          SELECT CASE(CONTROL_LOOP%PROBLEM%SPECIFICATION(3))
            CASE(PROBLEM_STANDARD_DARCY_SUBTYPE,PROBLEM_DARCY_BRINKMAN_SUBTYPE,&
               & PROBLEM_QUASISTATIC_DARCY_SUBTYPE,PROBLEM_TRANSIENT_DARCY_SUBTYPE)
              write(*,*)'It enters DARCY_EQUATION_PRE_SOLVE'
  ...
  SUBROUTINE DARCY_CONTROL_TIME_LOOP_PRE_LOOP(CONTROL_LOOP,err,error,*)
    ...
    SELECT CASE(CONTROL_LOOP%PROBLEM%SPECIFICATION(3))
      CASE(PROBLEM_STANDARD_DARCY_SUBTYPE,PROBLEM_DARCY_BRINKMAN_SUBTYPE, &
        ...
        write(*,*)'It enters DARCY_CONTROL_TIME_LOOP_PRE_LOOP'
        SOLVER_NUMBER_DARCY=1
...
999 ERRORSEXITS("DARCY_EQUATION_PRE_SOLVE_ALE_UPDATE_MESH",err,error)
  ...
  SUBROUTINE Darcy_PreSolveUpdateBoundaryConditions(CONTROL_LOOP,SOLVER,err,error,*)
    ...
    write(*,*)'It enters Darcy_PreSolveUpdateBoundaryConditions'
    IF(ASSOCIATED(CONTROL_LOOP)) THEN
      CONTROL_TIME_LOOP=>CONTROL_LOOP
      DO loop_idx=1,CONTROL_LOOP%CONTROL_LOOP_LEVEL
        IF(CONTROL_TIME_LOOP%LOOP_TYPE==PROBLEM_CONTROL_TIME_LOOP_TYPE) THEN
      ...
      IF(ASSOCIATED(SOLVER)) THEN
        IF(SOLVER%GLOBAL_NUMBER==SOLVER_NUMBER_DARCY) THEN
          IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
            ...
            SELECT CASE(CONTROL_LOOP%PROBLEM%SPECIFICATION(3))
              CASE(PROBLEM_STANDARD_DARCY_SUBTYPE,PROBLEM_DARCY_BRINKMAN_SUBTYPE)
                write(*,*)'It comes to Darcy_PreSolveUpdateBoundaryConditions'
                ! do nothing
              CASE(PROBLEM_QUASISTATIC_DARCY_SUBTYPE)
                ! do nothing
              CASE(PROBLEM_TRANSIENT_DARCY_SUBTYPE)
...
999 ERRORS("Darcy_PreSolveUpdateMatrixProperties",err,error)
  ...
  SUBROUTINE DARCY_EQUATION_POST_SOLVE(CONTROL_LOOP,SOLVER,err,error,*)
    ...
    write(*,*)'It enters DARCY_EQUATION_POST_SOLVE'
    IF(ASSOCIATED(CONTROL_LOOP)) THEN
      IF(ASSOCIATED(SOLVER)) THEN
        IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
          IF(.NOT.ALLOCATED(CONTROL_LOOP%PROBLEM%SPECIFICATION)) THEN
...
999 ERRORSEXITS("DARCY_EQUATION_POST_SOLVE",err,error)
  ...
  SUBROUTINE DARCY_EQUATION_POST_SOLVE_OUTPUT_DATA(CONTROL_LOOP,SOLVER,err,error,*)
    ...
    write(*,*)'It enters DARCY_EQUATION_POST_SOLVE_OUTPUT_DATA'
    IF(ASSOCIATED(CONTROL_LOOP)) THEN
      IF(ASSOCIATED(SOLVER)) THEN
        IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
          IF(.NOT.ALLOCATED(CONTROL_LOOP%PROBLEM%SPECIFICATION)) THEN
...
999 ERRORSEXITS("DARCY_EQUATION_POST_SOLVE_OUTPUT_DATA",err,error)
  ...
  SUBROUTINE Darcy_BoundaryConditionsAnalyticCalculate(EQUATIONS_SET,BOUNDARY_CONDITIONS,err,error,*)
    ...
    write(*,*)'It enters Darcy_BoundaryConditionsAnalyticCalculate'
    BOUND_COUNT=0
                                      ...
                                      CASE(FIELD_U_VARIABLE_TYPE)
                                        SELECT CASE(DOMAIN_NODES%NODES(node_idx)%DERIVATIVES(deriv_idx)%GLOBAL_DERIVATIVE_INDEX)
                                          CASE(NO_GLOBAL_DERIV)
                                            ...
                                            IF(component_idx==1) THEN
                                              !calculate u
											  write(*,*)'It comes to here inside boundary conditions analytic'
...
999 ERRORSEXITS("Darcy_PreSolveGetSolidDisplacement",err,error)
  ...
  SUBROUTINE Darcy_PreSolveStorePreviousIterate(CONTROL_LOOP,SOLVER,err,error,*)
    ...
    write(*,*)'It enters Darcy_PreSolveStorePreviousIterate'
...
!    INTEGER(INTG) :: equations_row_number
    ...
    write(*,*)'It enters Darcy_PreSolveUpdateAnalyticValues'
      ...
      IF(ASSOCIATED(SOLVER)) THEN
        IF(SOLVER%GLOBAL_NUMBER==SOLVER_NUMBER_DARCY) THEN
          IF(ASSOCIATED(CONTROL_LOOP%PROBLEM)) THEN
            ...
            SELECT CASE(CONTROL_LOOP%PROBLEM%SPECIFICATION(3))
              CASE(PROBLEM_STANDARD_DARCY_SUBTYPE, &
                & PROBLEM_DARCY_BRINKMAN_SUBTYPE,PROBLEM_QUASISTATIC_DARCY_SUBTYPE,PROBLEM_TRANSIENT_DARCY_SUBTYPE, &
                & PROBLEM_ALE_DARCY_SUBTYPE,PROBLEM_PGM_DARCY_SUBTYPE,PROBLEM_STANDARD_ELASTICITY_DARCY_SUBTYPE, &
                & PROBLEM_PGM_ELASTICITY_DARCY_SUBTYPE,PROBLEM_PGM_TRANSIENT_DARCY_SUBTYPE)
                ! do nothing
              CASE(PROBLEM_QUASISTATIC_ELASTICITY_TRANSIENT_DARCY_SUBTYPE,PROBLEM_QUASISTATIC_ELAST_TRANS_DARCY_MAT_SOLVE_SUBTYPE)
